...
export const getAllDoctorService = async (filters: any, options: IOptions) => {
...
export const updateDoctorService = async (id: string, payload: Partial<IDoctorUpdateInput>) => {
